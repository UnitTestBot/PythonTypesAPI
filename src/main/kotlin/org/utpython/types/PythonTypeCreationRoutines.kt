...
import org.utpython.types.general.CompositeTypeCreator
import org.utpython.types.general.FunctionTypeCreator
import org.utpython.types.general.Name
        ...
        CompositeTypeCreator.InitializationData(
            members = listOf(
                createPythonCallableType(
                    0,
                    List(argTypes.size + 1) { org.utpython.types.PythonCallableTypeDescription.ArgKind.ARG_POS },
    ...
    createPythonProtocol(
        ...
        CompositeTypeCreator.InitializationData(
            members = listOf(
                createPythonCallableType(
                    0,
                    List(argBounds.size) { org.utpython.types.PythonCallableTypeDescription.ArgKind.ARG_POS },
                    List(argBounds.size) { "" }
                ) {
