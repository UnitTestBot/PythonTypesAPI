...
internal class PythonCompositeTypeDescriptionTest {
    ...
    fun testMroForCounter() {
        ...
        val counterDescription = counter.pythonDescription() as org.utpython.types.PythonCompositeTypeDescription
        assertTrue(
    ...
    fun testMroForObject() {
        ...
        val description = obj.pythonDescription() as org.utpython.types.PythonCompositeTypeDescription
        assertTrue(
    ...
    fun testMroForDeque() {
        ...
        val description = deque.pythonDescription() as org.utpython.types.PythonCompositeTypeDescription
        assertTrue(
