...
import org.utpython.types.mypy.readMypyInfoBuildWithoutRoot
...
internal class PythonSubtypeCheckerTest {
    ...
    fun testCustomProtocol() {
        ...
        assertTrue(protocolP.pythonDescription() is org.utpython.types.PythonProtocolDescription)
        val classS = storage.definitions["subtypes"]!!["S"]!!.getUtBotType()
        assertTrue(classS.pythonDescription() is org.utpython.types.PythonConcreteCompositeTypeDescription)
        val classS1 = storage.definitions["subtypes"]!!["S1"]!!.getUtBotType()
        assertTrue(classS1.pythonDescription() is org.utpython.types.PythonConcreteCompositeTypeDescription)
    ...
    fun testCustomProtocolWithPossibleInfiniteRecursion() {
        ...
        assertTrue(protocolR.pythonDescription() is org.utpython.types.PythonProtocolDescription)
        val classRImpl = storage.definitions["subtypes"]!!["RImpl"]!!.getUtBotType()
        assertTrue(classRImpl.pythonDescription() is org.utpython.types.PythonConcreteCompositeTypeDescription)
    ...
    fun testAbstractSet() {
        ...
        assertTrue((abstractSet.pythonDescription() as org.utpython.types.PythonConcreteCompositeTypeDescription).isAbstract)
